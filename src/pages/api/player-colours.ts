...
export const POST: APIRoute = async ({ request, redirect }) => {
	...
	const playerOne = parseInt(JSON.parse(formData.get('player_1_colours')).id)
	const player_1_id = parseInt(JSON.parse(formData.get('player_1_colours')).player_id)
	...
	const playerTwo = parseInt(JSON.parse(formData.get('player_2_colours')).id)
	const player_2_id = parseInt(JSON.parse(formData.get('player_2_colours')).player_id)
