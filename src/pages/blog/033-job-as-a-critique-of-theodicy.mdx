...
title: 'Job As A Critique of Theodicy'
...
Could also call it "Job's three friends"

Intro...

## Old abstract

This essay explores the theological perspective of Job’s three friends, considers their function in the literary structure of the whole book, and determines whether the friends are a help or a hindrance to the overall message of the book. In doing so it reaches the following conclusions. First, the three friends represent the Ancient Near Eastern retribution principle. Second, within the literary context, they present this view in order for it to be rejected. Lastly, after proposing that the book of Job should be understood as a critique of theodicy, it is argued that the friends’ presentation of the retribution principle is necessary for the book’s purpose to be properly carried out.

---

## Introduction

The Ancient Near Eastern retribution principle as presented by Job’s friends Eliphaz, Bildad, and Zophar both contradicts and contributes to the message of the book of Job. This essay explores and evaluates this theological perspective, as well as observing its function in the literary structure of the Joban narrative and considering whether it helps or hinders the overall message of the book of Job. In the process it does the following. First, it summarises the conflicting understandings of human suffering that are present in the book of Job. Secondly, it draws attention to the competing claims to wisdom that each party puts forward. Lastly, it identifies the book of Job as a critique of ANE theodicy.
...
So, do Job’s friends help or hinder the overall message of the book? If the book truly is a critique of theodicy, then it is imperative that the mainstream theodicy of the ANE is presented. Consequently, Job’s friends’ theological perspectives are crucial to the agenda of the book, even if they are simply presented in order to be rejected. Without their perspectives, the book could certainly still declare that God alone is wise and that humanity cannot understand him, but it would also lose its polemic edge that would have been clearly apparent in its original context.
