...
When the Covid restrictions wound back, I went to their first physical gathering, and was then put on a team responsible for restarting Zoom church as a Sunday afternoon thing running in parallel with the morning gathering, but as a legitimate alternative gathering rather than a derivative service. I wasn't 100% sure about being assigned to the team, but went along with it, and after some initial hesitation, volunteered to do communion.
