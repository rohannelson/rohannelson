...
- Light editing
- Write introduction
- Transliterate Greek? (I'm erring on the side of not.)

Notes for intro:
Interesting artifact of my thinking pre-Mdiv (different hermeneutic etc. - e.g. talk about pattern of scripture).
Have since had experience of church boards as opposed to eldership which arguably function more as corporate governance.
David Boan as the only one to provide constructive criticism, saying I'd done a good job of identifying the 'loci' but I hadn't integrated it with my theology (I didn't really know what he meant by 'integrate it with my theology' at the time, because I didn't really have a concept of what theology was.)
...
> Titus 1:5-9 “<sup>5</sup>For this reason I left you in Crete, that you would set in order what remains and appoint elders in every city as I directed you, <sup>6</sup>namely, if any man is above reproach, the husband of one wife, having children who believe, not accused of reckless living or rebellion. <sup>7</sup>For the overseer must be above reproach as God’s steward, not self-pleasing, not quick-tempered, not addicted to wine, not violent, not fond of sordid gain, <sup>8</sup>but hospitable, loving what is good, sensible, just, devout, self-controlled, <sup>9</sup>holding fast the faithful word which is in accordance with the teaching, so that he will be able both to exhort in sound doctrine and to refute those who contradict.
